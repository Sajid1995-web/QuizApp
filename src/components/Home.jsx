  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        {/* Introduction – verbatim from the document, no heading */}
...
const styles = {
  page: {
    ...
    padding: "0", // removed padding so card touches edges
    position: "relative",
    overflow: "hidden",
  },
  bgCircle1: {
  ...
  card: {
    ...
    borderRadius: "0", // no rounded corners – full screen
    padding: "30px 36px 20px", // adjusted padding
    boxShadow: "none", // remove shadow for full-screen look
    textAlign: "center",
    position: "relative",
    zIndex: 1,
    ...
    overflow: "hidden", // no scroll – content fits
  },
  topImage: {
    position: "absolute",
    top: "20px",
  ...
  rulesContainer: {
    flex: "1 1 auto",
    overflowY: "auto", // in case content overflows (shouldn't with full screen)
    marginBottom: "8px",
    paddingRight: "4px",
  },
  rulesGrid: {
